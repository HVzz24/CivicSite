...
<html>
  <head>
    ...
    <meta name="author" content="civicsite.web.id">
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <div class='alert alert-warning alert-dismissible fade in' role='alert' style='border-radius:0px; margin-bottom:0px'>
          ...
          <a href="http://www.civicsite.web.id/" style="margin-right:10px; text-decoration:none;">Haloo Selamat datang di halaman administrator, Saat ini anda menggunakan CMS CivicSite CodeIgniter</a>
          <a target='_BLANK' class="btn btn-default btn-sm" href="https://www.civicsite.web.id/" style="color: rgb(243, 156, 18);">CivicSite Ci 1.2</a>
        </div>
      <?php } ?>
